using AzureWebJob.EmailNotification;
...
string emailBody = File.Exists(templatePath)
                    ...
                    : "<h2>WebJob Triggered Manual</h2><p>No template found.</p>";

// Replace tokens in HTML (if any)
emailBody = emailBody.Replace("##DateTime##", DateTime.Now.ToString());
emailBody = emailBody.Replace("##Message##", "API hit event successfully processed.");
